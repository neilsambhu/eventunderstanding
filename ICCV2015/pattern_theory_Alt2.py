...
def run(output_path, experiment_name, test_files_path, bond_weights_filename, number_of_iterations, feature_thresh,
    ...
    generator_space_filename = 'breakfast_priors/breakfast_generator_space_s4_0.8.txt'
    ...
    pred = LibSVMPredictor('SVM', 'hof', 'breakfast_models_s4.txt', 'breakfast_priors/breakfast_labels_s4_0.8.txt', './libsvm-3.17')
    ...
    ont = Ontology(generator_space_filename, 'breakfast_priors/breakfast_modalities_s4_0.8.txt', 'breakfast_priors_0.8_s4.txt')
