...
def run(output_path, experiment_name, test_files_path, bond_weights_filename, number_of_iterations, feature_thresh,
    ...
    pred = LibSVMPredictor('SVM', 'hof', 'breakfast_models_s3.txt', 'breakfast_priors/breakfast_labels_s3_0.8.txt', './libsvm-3.17')
    ...
    ont = Ontology(generator_space_filename, 'breakfast_priors/breakfast_modalities_s3_0.8.txt', 'breakfast_priors_0.8_s3.txt')
