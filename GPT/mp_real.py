...
#    experiment_type = 'regular'
    ...
    # execute experiments
    run(output_path, experiment_name, test_files_path, bond_weight_filename, number_of_iterations, feature_thresh,
        dynamic_inference, with_temporal_bonds, experiment_type, number_of_processes, top_k, [[2, 2, 1], [70, 70, 10]])
...
#    pred = LibSVMPredictor('SVM', 'hof', 'breakfast_models_s1.txt', 'breakfast_labels.txt', './libsvm-3.17')
    pred = PCAPredictor('PCA', 'spe', '/home/students/fillipe/ICPR2016/trial_training');
